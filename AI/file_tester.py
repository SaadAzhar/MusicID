...
def test_model_on_single_file(file_path):
    clf = joblib.load('C:\\Users\\hp\\Desktop\\project\\knndata.rar')
    X, y = read_fftx_test(create_fftx_test(convert_to_wav_format(file_path))+".npy")
...
if __name__ == "__main__":
    ...
    test_file="C:\\Users\\hp\\Desktop\\project\\testfiles\\11.mp3"
